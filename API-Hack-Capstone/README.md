...
#### HTML <br/>CSS <br/>Javascript <br/>jQuery <br/>Restful APIs <br/>  <space><space>*<space>[EatStreet API](https://developers.eatstreet.com/endpoint/search)  <br/>  <space><space>*<space>[TasteDive Movie API ](https://tastedive.com/read/api)<br/>Visual Studio Code <br/>Git Hub
